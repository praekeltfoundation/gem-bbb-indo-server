    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('intro', models.TextField(blank=True, help_text='The opening line said by the Coach when introducing the Survey.')),
                ('outro', models.TextField(blank=True, help_text='The closing line said by the Coach when finishing the Survey.')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            ...
            name='page',
            field=modelcluster.fields.ParentalKey(on_delete=django.db.models.deletion.CASCADE, related_name='custom_form_fields', to='survey.CoachSurvey'),
        ),
    ]
